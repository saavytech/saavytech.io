      ...
      <div>
        ...
        <form className="form-horizontal" onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <select name="todoPriority" className="form-control" id="inputTodoPriority" value={this.state.todoPriority} onChange={this.handleInputChange}>
